...
;(function($) {
	...
	$.peekABar = function(options) {
		...
		var _create = function() {
		    that.bar = $('<div></div>').attr('style', 'margin: 0;position: fixed;width: 100%;left: 0;right: 0;text-align: center;font-family: "Helvetica Neue",Helvetica,Arial,sans-serif;').attr('id', '__peek_a_bar_' + rand);

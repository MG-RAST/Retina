...
(function () {
	...
	update_data: function (params, index) {
	    ...
	    var url = renderer.settings.navigation_url + query + "&limit=" + renderer.settings.asynch_limit + "&offset=" + renderer.settings.offset + "&order=" +renderer.settings.filter_attribute;
